...
switch (true) do
{
	...
	case (player distance (getMarkerPos "oil_1_1") < 40) : {_mine = "oilu"; _val = 1;};
	case (player distance (getMarkerPos "oil_1_2") < 40) : {_mine = "oilu"; _val = 1;};
	case (player distance (getMarkerPos "oil_1_3") < 40) : {_mine = "oilu"; _val = 1;};
	case (player distance (getMarkerPos "oil_1_4") < 40) : {_mine = "oilu"; _val = 1;};
	case (player distance (getMarkerPos "oil_1_5") < 40) : {_mine = "oilu"; _val = 1;};
