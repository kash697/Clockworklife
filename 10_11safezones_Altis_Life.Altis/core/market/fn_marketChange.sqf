...
switch(true) do
{
	...
	{
		[[0,"News: Interpol has defeated an international drug gang!"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
	...
	{
		[[0,"News: China lost production in World-China-Center!"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
